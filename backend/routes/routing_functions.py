...
from voluptuous import DictInvalid
...
def flask_abort(
        status_code,
        message="This call was aborted. No additional information is given"):
    """Function to abort client call. Housed in routing functions
     so that we don't expose flask commands to the models.
